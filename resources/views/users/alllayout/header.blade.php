    ...
    <div id="top-header" >
        <div class="container">
            ...
            <ul class="header-links pull-right">
                @guest
                <li >
                    <a href="{{ route('login') }}"><i class="fa fa-sign-in"></i>{{ __('all.Login') }}</a>
                </li>
                <li >
                    <a href="{{ route('register') }}"><i class="fa fa-sign-in"></i>{{ __('all.Registe') }}</a>
                </li>
                @else
                ...
                <div class="col-md-6">
                    <div class="header-search">
                        <form>
                            ...
                            <input class="input" placeholder="{{__('all.Searchhere')}}">
                            <button class="search-btn">{{__('all.Search')}}</button>
                        </form>
                    </div>
                </div>
                <!-- /SEARCH BAR -->
