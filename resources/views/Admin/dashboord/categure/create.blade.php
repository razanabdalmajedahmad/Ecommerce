...
@section('title')
    <title>{{__('all.CreatenewCategure')}}</title>
    {{-- jquery --}}
                        ...
                        <form id="form">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8 col-md-10">
                                    ...
                                    <span class="invalid-feedback " style="display: block" id="invalid_feedback_image">
                                    </span>
                                    <img id="blah" src="#" alt="your image" hidden width="150" height="150"/>
                                </div>
                            </div>
    ...
    <script>
        $('#form').on('submit', function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('Categure_createnew_post') }}",
                data: formData,
                beforeSend: function() {
