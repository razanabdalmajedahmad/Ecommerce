        ...
        <div class="pagetitle col">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{ __('all.Categure') }}</li>
                </ol>
            </nav>
        </div>
        <div>
            <a class="btn btn-primary" href="{{ route('Categure_createnew') }}">{{ __('all.createnew') }}</a>
        </div>
    </div>
@endsection
@section('section')
