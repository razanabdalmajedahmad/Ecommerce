        ...
        <div class="pagetitle col">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{ __('all.coupons') }}</li>
                </ol>
            </nav>
        </div>
        <div>
            <a class="btn btn-primary" href="{{ route('coupon_createnew') }}">{{ __('all.createnew') }}</a>
        </div>
    </div>
@endsection
@section('section')
                    ...
                    <div class="card-body mt-5">
                        ...
                        <table class="table " style="width:100%" id="datatable">
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
                                    <th scope="col">{{ __('all.code') }}</th>
                                    <th scope="col">{{ __('all.value') }}</th>
