...
@section('title')
    <title>{{__('all.updatecoupons')}}</title>
    {{-- jquery --}}
        ...
        <div class="pagetitle col">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a>{{__('all.updatecoupons')}}</a></li>
                </ol>
            </nav>
        </div>
        <div>
                        ...
                        <form id="form">
                            <div class="row mb-3">
                                <div class="col-sm-6 ">
                                    ...
                                    <input type="text" value="{{$Coupon->code}}" class="form-control" name="code" id="inputText">
                                    <input type="text" hidden name="id" value="{{$Coupon->id}}"/>
                                    <span class="invalid-feedback" id="invalid_feedback_code">
                                    </span>
                                </div>
                                <div class="col-sm-6 ">
                                    <label for="inputEmail3" class="form-label">{{ __('all.value') }}%</label>
                                    <input type="number" value="{{$Coupon->value}}" class="form-control" name="value" id="inputText">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-6 ">
                                    ...
                                    <select name="status" class="form-control">
                                        <option @if($Coupon->status == "active") selected @endif value="active">{{ __('all.Active') }}</option>
                                        <option @if($Coupon->status == "inactive") selected @endif value="inactive">{{ __('all.Inactive') }}</option>
                                    </select>
